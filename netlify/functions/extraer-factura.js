...
- **DISPOSICIÓN EN VARIOS RENGLONES — el error más caro**: en los tickets de mayorista cada ítem ocupa DOS o TRES renglones. Ejemplo textual de un ticket real:
      5.950 x $ 11191.40
      JAMON COCIDO PALADINI GRANDE      $ 66588.86
      1 H
  Eso es **UN (1) ítem**: nombre "Jamon cocido", cantidad 5.95, precioUnitario 11191.40, importe 66588.86. El "1 H" es cuántas piezas físicas son y NO se devuelve como ítem. Devolver dos o tres ítems por ese bloque es el error más frecuente y el más caro: carga el mismo producto varias veces.
  Regla práctica: **la cantidad de ítems que devolvés tiene que ser igual a la cantidad de DESCRIPCIONES de producto que ves**, no a la cantidad de renglones impresos. Un renglón que es solo un número con o sin letra ("1 H", "4 H", "2 HORMA") nunca es un ítem.
- **NO REPITAS UN ÍTEM**: si el mismo producto al mismo precio unitario aparece en dos renglones del ticket, devolvelo como dos ítems solo si el ticket realmente lo cobró dos veces (dos importes distintos impresos). Nunca dupliques un ítem porque su bloque ocupaba varios renglones.
