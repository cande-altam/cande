...
```
  El equipo  -->  Experto del turno  -->  informe diario  -->  GERENCIA
                                                                  |
                                    Gerencia habla con la persona <+
```

- **Cada turno envía su informe.** Hay un Experto por turno en cada local, y cada uno
  deja el suyo.
- **Solo Gerencia lee los informes.** Ningún otro rol tiene acceso.
- **Gerencia es quien habla con la persona** si hace falta. El Experto informa, no
  sanciona.
