...
- Las bases/preparaciones (crema chantilly, bizcochuelo, almíbares, etc.) viven dentro de **Insumos** — un botón "🧪 Ver bases" muestra sus cards editables (insumos, cantidades, costo) sin tener que ir a otra pantalla.
