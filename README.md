...
- **Nunca más se crea un insumo en silencio.** Al guardar una factura, si alguna línea iba a crear un insumo nuevo **y se parece a alguno ya cargado**, se muestra antes de escribir nada: *«En la factura dice “CREMA DE LECHE X 1LT SANCOR”. ¿Es un insumo que ya tenés?»* con los candidatos y un "No, es uno nuevo". Elegir uno existente **enseña el alias**, así que ese texto ya no vuelve a preguntar nunca. Una línea genuinamente nueva (sin nada parecido) no interrumpe: se guarda de una.
