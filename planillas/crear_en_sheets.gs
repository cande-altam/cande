...
// Lista REAL exportada de Firebase (costeo/insumos), clasificada.
// [ambito, insumo, unidad, contenidoPorBulto, critico, alcance, grupo, precio, proveedor, alias]
const INSUMOS = [["Deposito central", "Propionato de calcio", "kg", 1.0, "NO", "Central", "Produccion", 19911.6632, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Almidon de maiz", "kg", 1.0, "NO", "Central", "Produccion", 2453.4359, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Aceite de girasol", "L", 5.0, "NO", "Central", "Produccion", 3241.861, "-Oy3x6PIXYLxiYAtPhXd", "aceite canuelas x 5 lt girasol"], ["Deposito central", "Aceite de oliva", "L", 1.0, "SI", "Central", "Produccion", 28116.0204, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Aditivo", "kg", 1.0, "NO", "Central", "Produccion", 6068.9994, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Panadería", "Albahaca", "kg", 1.0, "NO", "Por area", "Produccion", 5000, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Pastelería", "Anana", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Anana en lata", "kg", 1.0, "NO", "Central", "Produccion", 3567.8148, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Pastelería", "Arandanos", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Pastelería", "Arandanos congelados", "kg", 1.0, "NO", "Por area", "Produccion", 6561.1, "-Oy3x6_YT0XO-LGdauVw", ""], ["Deposito central", "Avena", "kg", 1.0, "NO", "Central", "Produccion", 2649.7064, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Azucar x 1 kg", "kg", 1.0, "SI", "Central", "Produccion", 907.6552, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Azúcar x 50 kg", "kg", 50.0, "SI", "Central", "Produccion", 1000, "-Oy3x6PIXYLxiYAtPhXd::dzero", ""], ["Deposito central", "Azucar mascabo", "kg", 1.0, "NO", "Central", "Produccion", 1542.7984, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Pastelería", "Banana", "docena", 1.0, "NO", "Por area", "Produccion", 166.6667, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Deposito central", "Chocolate baño semiamargo", "kg", 1.0, "NO", "Central", "Produccion", 13132.0009, "-Oy3x5HICG7dqWSc5Hqw::lodiser", ""], ["Deposito central", "Baño moldeo c/leche", "kg", 1.0, "NO", "Central", "Produccion", 9713.5896, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Berlina", "kg", 1.0, "NO", "Central", "Produccion", 6525.1669, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Deposito central", "Bicarbonato de amonio", "kg", 1.0, "NO", "Central", "Produccion", 9279.88, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Brownie express", "kg", 1.0, "NO", "Central", "Produccion", 10791.6853, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Deposito central", "Cacao", "kg", 1.0, "SI", "Central", "Produccion", 45065.6514, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Canela en polvo", "kg", 1.0, "SI", "Central", "Produccion", 30000, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Cerezas — Cofrutos", "kg", 1.0, "NO", "Central", "Produccion", "", "", ""], ["Deposito central", "Cerezas en lata", "kg", 1.0, "NO", "Central", "Produccion", 16912.2111, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Chocolate chip", "kg", 1.0, "NO", "Central", "Produccion", 18891.8994, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Chocolate moldeo", "kg", 1.0, "NO", "Central", "Produccion", 9610.0031, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Chocolate para submarino", "kg", 1.0, "SI", "Central", "Produccion", 25000, "-Oy3x5CU1wbvKIrHD_Ap", ""], ["Deposito central", "Chocolino", "kg", 1.0, "NO", "Central", "Produccion", 11145.8696, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Ciruelas", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Coco rallado", "kg", 1.0, "NO", "Central", "Produccion", 6859.06, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Colorante en pasta", "u", 1.0, "NO", "Central", "Produccion", 736.032, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Confites mini", "kg", 1.0, "NO", "Central", "Produccion", 14880, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Crema Vegetal", "L", 1.0, "SI", "Por area", "Produccion", 8159.22, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Deposito central", "Crocante de mani", "kg", 1.0, "NO", "Central", "Produccion", 11052.9991, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Culatello", "kg", 1.0, "NO", "Por area", "Produccion", 15000, "-Oy3x6FgGm8bAAjccrbI", ""], ["Deposito central", "Dulce de leche repostero", "kg", 25.0, "SI", "Central", "Produccion", 4416, "-Oy3x5M5XcdKeUTevCcM::campo quijano", ""], ["Deposito central", "Dulcerio tres leches", "kg", 1.0, "NO", "Central", "Produccion", 868.5269, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Deposito central", "Durazno al natural", "kg", 1.0, "NO", "Central", "Produccion", 2944.1513, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Emulsionante en pasta", "kg", 1.0, "SI", "Central", "Produccion", 25158.1909, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Fecula", "kg", 1.0, "NO", "Central", "Produccion", 2049.596, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Fondant", "kg", 1.0, "NO", "Central", "Produccion", 2766.936, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Fruta abrillantada", "kg", 1.0, "NO", "Central", "Produccion", "", "", ""], ["Pastelería", "Frutillas", "kg", 1.0, "NO", "Por area", "Produccion", 12857.1429, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Deposito central", "Frutillas congeladas", "kg", 1.0, "NO", "Por area", "Produccion", 6100, "-Oy3x6_YT0XO-LGdauVw", ""], ["Pastelería", "Frutos del bosque", "kg", 1.0, "SI", "Por area", "Produccion", 33057.85, "-Oy3x5CU1wbvKIrHD_Ap", ""], ["Deposito central", "Galletas chocolinas", "kg", 1.0, "NO", "Central", "Produccion", 9200, "-Oy3x5U5rkDaNIAPsni2", ""], ["Deposito central", "Galletas lincoln", "kg", 1.0, "NO", "Central", "Produccion", "", "", ""], ["Deposito central", "Galletas oreo", "kg", 1.0, "NO", "Central", "Produccion", 1400, "-Oy9iFzRrmC155dtg5_V", ""], ["Deposito central", "Galletas vainillas", "kg", 1.0, "NO", "Central", "Produccion", 7500, "-Oy9iFzRrmC155dtg5_V", ""], ["Deposito central", "Granas", "kg", 1.0, "NO", "Central", "Produccion", 4816.4055, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Grasa", "kg", 1.0, "SI", "Central", "Produccion", 5079.6, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Harina 0000 x25kg", "kg", 25.0, "SI", "Central", "Produccion", 840, "-Oy3x6BB2k7o0gjXohnv", ""], ["Deposito central", "Jalea fruta", "kg", 1.0, "NO", "Central", "Produccion", 1479.265, "-Oy3x5HICG7dqWSc5Hqw::calsa", ""], ["Especialidades", "Jamon cocido", "kg", 1.0, "NO", "Por area", "Produccion", 14983.0936, "-Oy3x6PIXYLxiYAtPhXd", "jamon cocido paladini grande"], ["Pastelería", "Kiwi", "kg", 1.0, "NO", "Por area", "Produccion", 4500, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Deposito central", "Lentejas chocolate", "kg", 1.0, "NO", "Central", "Produccion", 14903.7152, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Levadura", "kg", 1.0, "SI", "Central", "Produccion", 6742.1999, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Limon", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Mani filetiado", "kg", 1.0, "NO", "Central", "Produccion", 7890.8677, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Manzana verde", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Margarina hojaldre", "kg", 1.0, "SI", "Central", "Produccion", 5630.401, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Mayonesa — paquete 1 kg", "kg", 1.0, "NO", "Central", "Produccion", 1000, "", ""], ["Deposito central", "Mermelada ciruela", "kg", 1.0, "NO", "Central", "Produccion", 3112.2907, "_manual", ""], ["Deposito central", "Mermelada durazno", "kg", 1.0, "NO", "Central", "Produccion", 4078.8626, "-Oy3x6PIXYLxiYAtPhXd::oriel", "mermelada ortega fco durazno x 40"], ["Deposito central", "Mermelada frutilla", "kg", 1.0, "NO", "Central", "Produccion", 5490.375, "-Oy3x6PIXYLxiYAtPhXd::orieta", "mermelada ortega fco frutilla x 4"], ["Deposito central", "Miel de abeja — Squezze Aleluya", "kg", 1.0, "NO", "Central", "Produccion", 13324.416, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Miel de caña", "kg", 1.0, "NO", "Central", "Produccion", 12754.2816, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Pastelería", "Mix de frutos rojos", "kg", 1.0, "NO", "Por area", "Produccion", 8700.0076, "-Oy3x6_YT0XO-LGdauVw", ""], ["Deposito central", "Mix de semillas", "kg", 1.0, "NO", "Central", "Produccion", 5208, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Mortadela", "kg", 1.0, "NO", "Por area", "Produccion", 13290, "-Oy3x6FgGm8bAAjccrbI", ""], ["Deposito central", "Mortadela con pistachos", "kg", 1.0, "NO", "Por area", "Produccion", 10320.01, "-Oy3x6FgGm8bAAjccrbI", ""], ["Deposito central", "Naranja — paquete lt", "L", 1.0, "NO", "Por area", "Produccion", 1200, "", ""], ["Deposito central", "Nutella", "kg", 1.0, "SI", "Central", "Produccion", 29001.6501, "-Oy3x5zQJsff2tXic0En", ""], ["Panadería", "Oregano", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Otentic", "kg", 1.0, "SI", "Central", "Produccion", 57233.3025, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Deposito central", "Panes blandos", "kg", 1.0, "NO", "Por area", "Produccion", 6987.7559, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Panadería", "Panes granos andinos", "kg", 1.0, "NO", "Por area", "Produccion", 9191.8819, "-Oy3x5PQG-Q_8gCTDCC4::puratos", ""], ["Panadería", "Panes multicereal", "kg", 1.0, "NO", "Por area", "Produccion", 9191.8819, "-Oy3x5PQG-Q_8gCTDCC4::puratos", ""], ["Panadería", "Panes salvado", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Pasas de uva", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Pasta de pistachos", "kg", 1.0, "SI", "Central", "Produccion", 55851.2368, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Pernil", "kg", 1.0, "NO", "Por area", "Produccion", 8667.8108, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Polvo para hornear", "kg", 1.0, "NO", "Central", "Produccion", 15358.8506, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Premezcla muffin", "kg", 1.0, "NO", "Central", "Produccion", 9043.9998, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Premezcla pan de papa", "kg", 1.0, "NO", "Central", "Produccion", 19039.4238, "", ""], ["Panadería", "Premezcla pan de queso", "kg", 1.0, "NO", "Por area", "Produccion", 6885.0028, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Pulpalist neutro", "kg", 1.0, "NO", "Central", "Produccion", 9426.8002, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Especialidades", "Queso cremoso", "kg", 1.0, "NO", "Por area", "Produccion", 7293.9, "-Oy5lEAvhTTuFPOgLwJI", ""], ["Deposito central", "Rocklets - lentejas de chocolate", "kg", 1.0, "NO", "Central", "Produccion", 13499.728, "", ""], ["Panadería", "Romero", "kg", 1.0, "NO", "Por area", "Produccion", 24.8, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Sal", "kg", 1.0, "NO", "Central", "Produccion", 233.1912, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Salame — Milan", "kg", 1.0, "NO", "Por area", "Produccion", 17879.01, "-Oy3x6FgGm8bAAjccrbI", "salame, salame la francisca"], ["Deposito central", "Salamin — paquete unidad", "u", 1.0, "NO", "Por area", "Produccion", 29580.0956, "-Oy3x6PIXYLxiYAtPhXd", "salamin, salamin la francisca, salamin paladini"], ["Deposito central", "Salsa de chocolate x900gr", "kg", 1.0, "NO", "Central", "Produccion", 6611.5667, "-Oy3x5CU1wbvKIrHD_Ap", ""], ["Deposito central", "Salsa para pizza", "kg", 1.0, "NO", "Central", "Produccion", 856.8, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Salvado de trigo", "kg", 20.0, "NO", "Central", "Produccion", 948.0876, "-Oy3x5HICG7dqWSc5Hqw::jupiter", ""], ["Deposito central", "Semillas de amapola", "kg", 1.0, "NO", "Central", "Produccion", 18600, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Semillas de sesamo", "kg", 1.0, "NO", "Central", "Produccion", 12400, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Panadería", "Spekkel", "kg", 1.0, "NO", "Por area", "Produccion", 9191.8819, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Deposito central", "Tegral torta", "kg", 1.0, "NO", "Central", "Produccion", 7457.8272, "-Oy3x5PQG-Q_8gCTDCC4", ""], ["Deposito central", "Tomates", "kg", 1.0, "NO", "Por area", "Produccion", 3000, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Especialidades", "Tomates cherrys", "kg", 1.0, "NO", "Por area", "Produccion", 2000, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Deposito central", "Variegato Frutos del bosque", "kg", 1.0, "NO", "Por area", "Produccion", 11764.624, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Variegato Maracuya", "kg", 1.0, "NO", "Central", "Produccion", 10821.8183, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Pistachos", "kg", 1.0, "SI", "Central", "Produccion", 39000, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Bicarbonato de sodio", "kg", 1.0, "NO", "Central", "Produccion", 12000, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Satin carrot", "kg", 1.0, "NO", "Central", "Produccion", 8855.8518, "", ""], ["Deposito central", "Premezcla brownie x3kg", "kg", 3.0, "NO", "Central", "Produccion", 11593.9982, "", ""], ["Deposito central", "Bondiola", "kg", 1.0, "SI", "Por area", "Produccion", 27759.4691, "", ""], ["Deposito central", "Tegral brownie", "kg", 1.0, "NO", "Central", "Produccion", 11056.9824, "", ""], ["Deposito central", "Chocolinas", "kg", 1.0, "NO", "Central", "Produccion", 2662, "", ""], ["Cocina San Luis", "queso roquefort", "kg", 1.0, "NO", "Por area", "Produccion", 14027.53, "", ""], ["Deposito central", "Cantimpalo", "kg", 1.0, "SI", "Por area", "Produccion", 28023.6, "-Oy3x6FgGm8bAAjccrbI", "salame, salame cantimpalo goggi"], ["Deposito central", "Lomito ahumado", "kg", 1.0, "SI", "Por area", "Produccion", 37606.3039, "-Oy3x6PIXYLxiYAtPhXd", "jamon cocido"], ["Deposito central", "Durazno", "kg", 1.0, "NO", "Por area", "Produccion", 1361, "", ""], ["Deposito central", "Frutas", "kg", 1.0, "NO", "Por area", "Produccion", 11040, "-Oy3x5cgg3zdamPydBR_", ""], ["Deposito central", "Lechuga", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Queso crema x pouch", "kg", 1.0, "SI", "Por area", "Produccion", 40387.6, "-OyYs0PCr53ZOD2Famxb::casancrem", ""], ["Deposito central", "Sirope", "kg", 1.0, "NO", "Central", "Produccion", "", "", ""], ["Deposito central", "Claras", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Premezcla Easy Pannettone", "kg", 1.0, "NO", "Central", "Produccion", "", "", ""], ["Deposito central", "Yemas", "kg", 1.0, "NO", "Por area", "Produccion", "", "", ""], ["Deposito central", "Almendras", "kg", 1.0, "SI", "Central", "Produccion", 34720, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Azucar impalpable", "kg", 1.0, "NO", "Central", "Produccion", 3027.2784, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Crema de leche", "kg", 1.0, "SI", "Por area", "Produccion", 26012.19, "-Oy5lEAvhTTuFPOgLwJI", ""], ["Deposito central", "Dulce de membrillo", "kg", 1.0, "NO", "Central", "Produccion", 3940.6022, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Esencia de vainilla", "kg", 1.0, "NO", "Central", "Produccion", 2683.2331, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Granola", "kg", 1.0, "NO", "Central", "Produccion", 13800, "-Oy3x4zIVCAfQD8ZLMle", ""], ["Deposito central", "Harina 000 x25kg", "kg", 25.0, "SI", "Central", "Produccion", 840, "-Oy3x6BB2k7o0gjXohnv", ""], ["Deposito central", "Huevos", "kg", 1.0, "SI", "Por area", "Produccion", 4000, "-Oy9iHFKHzQfOCWS2yMx::lila", ""], ["Deposito central", "Jamon crudo", "kg", 1.0, "SI", "Por area", "Produccion", 47650.01, "-Oy3x6FgGm8bAAjccrbI::la francisca", ""], ["Deposito central", "Leche entera", "kg", 1.0, "SI", "Por area", "Produccion", 1462.164, "-Oy3x5hUUrbMdfLny41w", ""], ["Deposito central", "Manteca en pilón", "kg", 1.0, "SI", "Por area", "Produccion", 121332.64, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Margarina masa", "kg", 1.0, "SI", "Central", "Produccion", 5630.402, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Mayonesa", "kg", 2900.0, "NO", "Central", "Produccion", 3973.6567, "-Oy3x6PIXYLxiYAtPhXd", "mayonesa mayonesa x 2900 cc"], ["Deposito central", "Mermelada de membrillo", "kg", 1.0, "NO", "Central", "Produccion", 2254.5065, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Miel de abeja", "kg", 1.0, "SI", "Central", "Produccion", 29495.5824, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Naranja", "kg", 1.0, "NO", "Por area", "Produccion", 4500, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Deposito central", "Nueces", "kg", 1.0, "NO", "Central", "Produccion", 15000, "_manual", ""], ["Cocina San Luis", "Palta", "kg", 1.0, "NO", "Por area", "Produccion", 6500, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Deposito central", "Queso azul", "kg", 1.0, "SI", "Por area", "Produccion", 25054.8324, "-Oy3x6FgGm8bAAjccrbI", ""], ["Deposito central", "Queso de cabra", "kg", 1.0, "NO", "Por area", "Produccion", 13900, "-Oy9i7sX4WQLLHbd5dNR", ""], ["Especialidades", "Queso sardo", "kg", 1.0, "NO", "Por area", "Produccion", 13294.7056, "-Oy3x6PIXYLxiYAtPhXd", "sardo d 70"], ["Especialidades", "Queso tybo", "kg", 1.0, "SI", "Por area", "Produccion", 33403.02, "-Oy3x6PIXYLxiYAtPhXd::la paulina", "tyro sandwich"], ["Deposito central", "Rucula", "kg", 1.0, "NO", "Por area", "Produccion", 500, "-Oy9i7sX4WQLLHbd5dNR", "rucula cafe, rucula cofrutos"], ["Deposito central", "Gelatina S/Sabor", "kg", 1.0, "SI", "Central", "Produccion", 47619.0476, "_manual", ""], ["Deposito central", "Salsa Inglesa", "kg", 1.0, "NO", "Central", "Produccion", 1319.0528, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Premezcla budin chocolate", "kg", 1.0, "NO", "Central", "Produccion", 7718.0011, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Premezcla budin vainilla", "kg", 1.0, "NO", "Central", "Produccion", 5422.9982, "-Oy3x5HICG7dqWSc5Hqw", ""], ["Deposito central", "Queso muzzarella", "kg", 1.0, "SI", "Por area", "Produccion", 22473.33, "-Oy3x6PIXYLxiYAtPhXd::aurora", ""], ["Deposito central", "Peceto", "kg", 1.0, "SI", "Por area", "Produccion", 20000, "-Oy3x5sggwuQBtMEb2uy", "ternera"], ["Deposito central", "Dulce de cayote", "kg", 1.0, "NO", "Central", "Produccion", 4000, "-OyZ4ZPPwu1kisPflQT4", ""], ["Deposito central", "Mozzarella Cilindro Aurora / Pianu", "kg", 1.0, "NO", "Por area", "Produccion", "", "-Oy3x6PIXYLxiYAtPhXd", "mozzarella cilindro"], ["Deposito central", "Tybo Sandwich La Paulina", "kg", 1.0, "NO", "Por area", "Produccion", "", "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Manteca Teodoro x 5 kg", "kg", 5.0, "SI", "Por area", "Produccion", "", "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Azúcar Doña Bertina x 1 kg", "kg", 1.0, "NO", "Central", "Produccion", "", "-Oy3x6PIXYLxiYAtPhXd", ""]];
// Quedan en el maestro como referencia pero NO se cuentan: semielaborados que se
// hacen en casa (almibares, cremas, masas) y articulos de reventa/cafeteria.
const INSUMOS_FUERA = [["Deposito central", "Leche de almendras", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 2310.82, "-Oy3x79ILHmcrJFf2cFU", ""], ["Deposito central", "Leche de coco", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 3946.06, "-Oy3x79ILHmcrJFf2cFU", ""], ["Deposito central", "Leche deslactosada", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 1435.26, "-Oy5lEAvhTTuFPOgLwJI", ""], ["Deposito central", "licor", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 8550.6667, "-Oy3x5U5rkDaNIAPsni2", ""], ["Deposito central", "Syrope avellanas", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 13900, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Syrope caramelo", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 13899.996, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Syrope coco", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 13900, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Syrope vainilla", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 13900, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Syrup Pistacho", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 17099.9983, "-Oy3x5zQJsff2tXic0En", ""], ["Deposito central", "Tulipas", "kg", 1.0, "NO", "Central", "Semielaborado propio", 100, "_manual", ""], ["Deposito central", "Yogurt natural", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 5320, "-Oy9iSi3RKNpfwUiMVPE", ""], ["Deposito central", "café instantaneo", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 6252.0942, "", ""], ["Deposito central", "Pan de miga", "kg", 1.0, "NO", "Central", "Semielaborado propio", 12500, "-Oy3x6pWOEfg-38KOqwf", ""], ["Deposito central", "Café — paquete 1/4", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 13960.7, "", ""], ["Deposito central", "Agua saboriz", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 3200, "", ""], ["Deposito central", "Agua", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 2500, "", ""], ["Deposito central", "Bagel", "kg", 1.0, "NO", "Central", "Semielaborado propio", 800, "", ""], ["Deposito central", "Churro", "u", 1.0, "NO", "Central", "Semielaborado propio", 600, "", ""], ["Deposito central", "Cookies", "u", 1.0, "NO", "Central", "Semielaborado propio", "", "", ""], ["Deposito central", "Croissant", "kg", 1.0, "NO", "Central", "Semielaborado propio", 1000, "", ""], ["Deposito central", "Donas", "kg", 1.0, "NO", "Central", "Semielaborado propio", 1400, "", ""], ["Deposito central", "Focaccia", "kg", 1.0, "NO", "Central", "Semielaborado propio", 1000, "", ""], ["Deposito central", "Ganache", "kg", 1.0, "NO", "Central", "Semielaborado propio", 277.3374, "", ""], ["Deposito central", "Gaseosa", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 3200, "", ""], ["Deposito central", "Helado", "kg", 1.0, "NO", "Central", "Semielaborado propio", 2400, "", ""], ["Deposito central", "Leche Descremada", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 1052.22, "", ""], ["Deposito central", "MiniBaguette", "kg", 1.0, "NO", "Central", "Semielaborado propio", 120, "", ""], ["Deposito central", "Soda", "L", 1.0, "NO", "Central", "Reventa / cafeteria", 500, "", ""], ["Deposito central", "Tortillas", "u", 1.0, "NO", "Central", "Semielaborado propio", "", "", ""], ["Deposito central", "Tostadas Blancas", "kg", 1.0, "NO", "Central", "Semielaborado propio", 3500, "", ""], ["Deposito central", "Tostadas Granos Andinos", "kg", 1.0, "NO", "Central", "Semielaborado propio", 4200, "", ""], ["Deposito central", "Tostadas Multicereal", "kg", 1.0, "NO", "Central", "Semielaborado propio", 4200, "", ""], ["Deposito central", "Tostadas Salvados", "kg", 1.0, "NO", "Central", "Semielaborado propio", 3800, "", ""], ["Deposito central", "Hielo", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 1000, "", ""], ["Deposito central", "Azucar en Sobre", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 17.8104, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Miga de jamon cocido", "kg", 1.0, "NO", "Por area", "Semielaborado propio", "", "", ""], ["Deposito central", "Miga de jamon crudo", "kg", 1.0, "NO", "Por area", "Semielaborado propio", "", "", ""], ["Deposito central", "Yogurt griego", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 6110, "-Oy9iSi3RKNpfwUiMVPE::mykra", "yogurt griego greenway, yogurt griego paquete kg"], ["Deposito central", "Saquito de Te La Virginia", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 92.7453, "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Café en grano x kg", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 49610, "-Oy3x5kjWPRVdMK1uF8i::cherry’s season", ""], ["Deposito central", "Crema Chantilly", "kg", 1.0, "NO", "Central", "Semielaborado propio", 5385.901122, "_manual", ""], ["Deposito central", "Bizcochuelo de Vainilla", "kg", 1.0, "NO", "Central", "Semielaborado propio", 3158.9565846875003, "_manual", ""], ["Deposito central", "Almibar Para Tortas", "kg", 1.0, "NO", "Central", "Semielaborado propio", 3565.2709519107993, "_manual", ""], ["Deposito central", "Masa Frola", "kg", 1.0, "NO", "Central", "Semielaborado propio", 1374.5139795999999, "_manual", ""], ["Deposito central", "Crema Pastelera", "kg", 1.0, "NO", "Central", "Semielaborado propio", 1634.8938451722, "_manual", ""], ["Deposito central", "Almibar P/Facturas", "kg", 1.0, "NO", "Central", "Semielaborado propio", 2155.3277617146, "_manual", ""], ["Deposito central", "Powerade Mountain Blast", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 11040, "-Oy3x5cgg3zdamPydBR_", ""], ["Deposito central", "Sprite 1.5L", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 19999.88, "-Oy3x5cgg3zdamPydBR_", ""], ["Deposito central", "Sprite 2.25L", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 24999.87, "-Oy3x5cgg3zdamPydBR_", ""], ["Deposito central", "Smoothie mix violeta", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 5792.86, "-Oy3x6_YT0XO-LGdauVw::alif", ""], ["Deposito central", "Smoothie mix amarillo", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 5792.86, "-Oy3x6_YT0XO-LGdauVw::alif", ""], ["Deposito central", "Vela corta", "u", 1.0, "NO", "Central", "Reventa / cafeteria", 1652.89, "-OyYsCLjF8XwEJhXle4Q", ""], ["Deposito central", "Bengala Gibre", "kg", 1.0, "NO", "Central", "Reventa / cafeteria", 826.45, "-OyYsCLjF8XwEJhXle4Q", ""], ["Deposito central", "Stevia hileret x 400 sobres", "u", 400.0, "NO", "Central", "Reventa / cafeteria", "", "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Edulcorante hileret forte x 400 sobres", "u", 400.0, "NO", "Central", "Reventa / cafeteria", "", "-Oy3x6PIXYLxiYAtPhXd", ""], ["Deposito central", "Higienol", "u", 30.0, "NO", "Central", "Reventa / cafeteria", "", "-Oy3x6PIXYLxiYAtPhXd", "higienol x 30 mts floripel"], ["Deposito central", "Horma", "u", 1.0, "NO", "Central", "Reventa / cafeteria", "", "-Oy3x6PIXYLxiYAtPhXd", ""]];
...
function crearInsumos_(ss) {
  ...
  anchos_(h, [140, 270, 65, 95, 85, 95, 150, 110, 150, 190]);
  const todos = INSUMOS.concat(INSUMOS_FUERA);
  titulo_(h, 10, 'MAESTRO DE INSUMOS (' + INSUMOS.length + ' en control, ' + INSUMOS_FUERA.length + ' fuera)',
  ...
  cabecera_(h, 3, ['AMBITO\n(donde se cuenta)','INSUMO','UNIDAD','CONTENIDO\nPOR BULTO','CRITICO\n(conteo diario)',
                   'ALCANCE','GRUPO','PRECIO\nACTUAL $','PROVEEDOR (id)','ALIAS EN FACTURAS']);
  const n = todos.length;
  h.getRange(4,1,n,10).setValues(todos.map(function(r){
  ...
  if (INSUMOS_FUERA.length > 0) {
    h.getRange(4 + INSUMOS.length, 1, INSUMOS_FUERA.length, 10)
  ...
  h.getRange(3,1,n+1,10).createFilter();
}
